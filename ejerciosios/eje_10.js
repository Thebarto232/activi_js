...
let ingredientes = ["Pimiento y tofu", "Pepperoni, Jamón y Salmón"];

function pizza() {

    let tipo = prompt("Ingrese el ingrediente que desea buscar:");


    if (ingredientes.includes(tipo)) {
        alert("Este ingrediente está en la lista de pizzas.");
    } else {
        alert("Este ingrediente no está en la lista de pizzas.");
    }
}
